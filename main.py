    ...
    for class_name in classes:
        ...
        for audio_file in os.listdir(class_audio_dir):
            if audio_file.endswith('.wav'):
                ...
                # Define variations with added pitch shifting
                variations = [
                    ('orig', y),
                    ...
                    # ('vol08', y * 0.8),
                    # ('pitch_up', librosa.effects.pitch_shift(y, sr=sr, n_steps=2)),  # Pitch shift up
                    # ('pitch_down', librosa.effects.pitch_shift(y, sr=sr, n_steps=-2))  # Pitch shift down
                ]
